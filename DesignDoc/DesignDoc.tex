...
\tikzstyle{cloud2} = [draw, circle,fill=red!40, node distance=3cm,
minimum height=6em]
\begin{center}
\begin{tikzpicture}
...
\lstinputlisting[label=samplecode,caption=Network Manager]{networkManager.h}
...
\end{itemize}
\lstinputlisting[label=samplecode,caption=Space Object]{spaceObject.h}
...
\end{itemize}
\vfill
\lstinputlisting[label=samplecode,caption=Physics]{cuboid.h}
...
\end{itemize}
\lstinputlisting[label=samplecode,caption=Player]{Player.h}
\subsection{AI}
