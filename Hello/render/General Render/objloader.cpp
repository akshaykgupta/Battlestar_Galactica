...
int objloader::load(const char* filename)
{
        ...
        //-------------------------------- READING THE FILE AND STORING IT IN A VECTOR-------------//
        ...
        //-------------------------------- PROCESSING THE VALUES IN THE OBJ FILE-------------------//
                        ...
                        {      
                                ...
                                }else if(coord[i]->find("/")!=std::string::npos)        //if we have texture coorinate and normal vectors
                                {
                                        ...
                                        }else if(coord[i]->find("/")!=std::string::npos)
                                        {
                                                ...
                                                sscanf(coord[i]->c_str(),"f %d/%d %d/%d %d/%d",&a,&t[0],&b,&t[1],&c,&t[2]);
                                                faces.push_back(new face(-1,a,b,c,t[0],t[1],t[2],curmat));
                                        }else{
                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                        //all of the materials
        {
                ...
                strcpy(filename,"\0");  //set filename to nullbyte character
                 long counter=0;
                for(int i=0;i<tmp.size();i++,counter++) //go through all lines of the mtllib file
                {
        ...
        glScalef(1.0,1.0,1.0);
                ...
                {std::cout<<"So call me maybe \n";
                        ...
                        glEnd();
                }else{std::cout<<"So call me maybe :(\n";
